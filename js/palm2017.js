...
image1.addEventListener("click", function () {                    
    jaquette.src = "../image/recompense/sl(1).jpg" 
...
image2.addEventListener("click", function () {                    
    jaquette.src = "../image/recompense/sl(2).jpg" 
    score.style.display = "block"
    score2.style.display = "block"
    amazon.style.display = "block"
})
...
image3.addEventListener("click", function () {                    
    jaquette.src = "../image/recompense/sl(3).jpg" 
    score.style.display = "block"
    score2.style.display = "block"
    amazon.style.display = "block"
})
...
image4.addEventListener("click", function () {                    
    jaquette.src = "../image/recompense/sl(4).jpg" 
    score.style.display = "block"
    score2.style.display = "block"
    amazon.style.display = "block"
})